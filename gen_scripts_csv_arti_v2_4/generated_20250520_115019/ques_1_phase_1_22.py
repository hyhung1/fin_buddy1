...
# Group by sector and sum the net profit for each year
sector_yearly_profit = df.groupby(sector_column)[net_profit_columns].sum()

# Calculate the total net profit for the period 2019-2023 for each sector
sector_total_profit = sector_yearly_profit.sum(axis=1)

# Sort sectors by total profit in descending order and get the top 3
top_sectors = sector_total_profit.sort_values(ascending=False).head(3)

# Print the top 3 sectors and their total profit
