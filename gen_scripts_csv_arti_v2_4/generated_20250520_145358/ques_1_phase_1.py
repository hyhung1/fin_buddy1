...
# Calculate the total net profit for the period 2019-2023 for each sector
sector_profit['Total Net Profit (2019-2023)'] = sector_profit[net_profit_cols].sum(axis=1)

# Sort sectors by total net profit in descending order and get the top 3
top_3_sectors = sector_profit.sort_values(by='Total Net Profit (2019-2023)', ascending=False).head(3)

# Print the results
for index, row in top_3_sectors.iterrows():
    print(f"{index}: {row['Total Net Profit (2019-2023)']:.2f}")
