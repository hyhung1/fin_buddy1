...
sector_yearly_net_profit = df.groupby(sector_col)[net_profit_cols].sum()

# Calculate the total net profit for the period 2019-2023 for each sector
sector_total_net_profit = sector_yearly_net_profit.sum(axis=1)

# Sort sectors by total net profit in descending order and get the top 5
top_5_sectors = sector_total_net_profit.sort_values(ascending=False).head(5)

# Print the result
print("Top 5 Sectors by Total Net Profit (2019-2023) (Billions VND):")
