...
df['Total_Net_Profit_2019_2023'] = df[net_profit_cols].sum(axis=1)

# Group by sector and sum the total net profit
sector_total_profit = df.groupby(sector_col)['Total_Net_Profit_2019_2023'].sum()

# Sort sectors by total profit in descending order and get the top 3
