...
# Use .loc to avoid SettingWithCopyWarning if df was a slice,
# although in this context, df is the original DataFrame.
...
# Print the result
print("Top 3 Sectors with Highest Total Net Profit (2019-2023):")
