...
# Define the columns for Net profit after tax for the years 2019 to 2023
net_profit_cols = [
...
# Calculate the total net profit for each company across the years
...
df = df.drop(columns=['Total Net Profit 2019-2023'])
